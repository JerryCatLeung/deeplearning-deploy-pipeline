...
#0 config
model_dir=/dockerdata/lambdaji/ml_packages/tf_repos/CTR/model_ckpt/criteo/
...
python DCN.py --dist_mode=2 --learning_rate=0.0001 --optimizer=Adam --num_epochs=1 --embedding_size=32 --batch_size=256 --field_size=39 --feature_size=117581 --deep_layers=256,128 --cross_layers=2 --dropout=0.8,0.8 --l2_reg=0.0001 --log_steps=1000 --data_dir=/data/ceph/CTR/data/criteo/ --model_dir=/data/ceph/CTR/model_ckpt/ --clear_existing_model=True
